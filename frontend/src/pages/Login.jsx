        ...
        <div className="w-full md:w-1/2 p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <button 
                type="submit" 
                className="w-full flex items-center justify-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition duration-300 shadow-md hover:shadow-lg"
                disabled={isLoading}
              >
                {isLoading ? (
          ...
          >
            <p className="text-gray-600">
              ...
              <a href="/signup" className="text-blue-600 font-medium hover:underline transition duration-200">
                Sign up
              </a>
            </p>
          </motion.div>
